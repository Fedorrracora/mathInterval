...
template <typename T>
auto cast = [](
    const std::variant<interval::minimal<T>, interval::maximal<T>, py::object> &a)-> std::variant<
    interval::minimal<T>, interval::maximal<T>, PyValue> {
...
void bind_interval(py::module_ &m, const char *class_name) {
    ...
    cls.def(py::init<>())
       ...
       .def("__add__", [](const Interval &a, const Interval &b) { return a + b; }, py::is_operator(), py::arg("b"),
            "returns a new multitude containing the union of the elements of the previous multitudes")
       .def("__or__", [](const Interval &a, const Interval &b) { return a + b; }, py::is_operator(), py::arg("b"),
            "returns a new multitude containing the union of the elements of the previous multitudes")
       .def("__iadd__", [](Interval &a, const Interval &b) { return a += b; }, py::is_operator(), py::arg("b"),
            "adds elements of another multitude")
       .def("__ior__", [](Interval &a, const Interval &b) { return a += b; }, py::is_operator(), py::arg("b"),
            "adds elements of another multitude")
       .def("__sub__", [](const Interval &a, const Interval &b) { return a - b; }, py::is_operator(), py::arg("b"),
            "returns a new multitude containing the difference of the elements of the previous multitudes")
       .def("__isub__", [](Interval &a, const Interval &b) { return a -= b; }, py::is_operator(), py::arg("b"),
            "remove elements of another multitude")
       .def("__mul__", [](const Interval &a, const Interval &b) { return a * b; }, py::is_operator(), py::arg("b"),
            "returns a new multitude containing the intersection of the elements of the previous multitudes")
       .def("__and__", [](const Interval &a, const Interval &b) { return a * b; }, py::is_operator(), py::arg("b"),
            "returns a new multitude containing the intersection of the elements of the previous multitudes")
       .def("__imul__", [](Interval &a, const Interval &b) { return a *= b; }, py::is_operator(), py::arg("b"),
            "intersect elements with another multitude")
       .def("__iand__", [](Interval &a, const Interval &b) { return a *= b; }, py::is_operator(), py::arg("b"),
            "intersect elements with another multitude")
       .def("__xor__", [](const Interval &a, const Interval &b) { return a ^ b; }, py::is_operator(), py::arg("b"),
            "returns a new multitude containing the symmetric difference of the elements of the previous multitudes")
       .def("__ixor__", [](Interval &a, const Interval &b) { return a ^= b; }, py::is_operator(), py::arg("b"),
    ...
    if constexpr (type_policy::template is_arithmetic_v<T>)
        cls
            .def("__add__", [](const Interval &a, const T &b) { return a + b; }, py::is_operator(), py::arg("b"),
                 "returns a new multitude with the points shifted forward by the distance val")
            .def("__iadd__", [](Interval &a, const T &b) { return a += b; }, py::is_operator(), py::arg("b"),
                 "shift the points forward by a distance of val")
            .def("__sub__", [](const Interval &a, const T &b) { return a - b; }, py::is_operator(), py::arg("b"),
                 "returns a new multitude with the points shifted backward by the distance val")
            .def("__isub__", [](Interval &a, const T &b) { return a -= b; }, py::is_operator(), py::arg("b"),
                 "shift the points backward by a distance of val")
            .def("__mul__", [](const Interval &a, const T &b) { return a * b; }, py::is_operator(), py::arg("b"),
                 "returns a new multitude with the points multiplied by a factor of val")
            .def("__imul__", [](Interval &a, const T &b) { return a *= b; }, py::is_operator(), py::arg("b"),
                 "multiplies the points of a multitude by a factor of val");
    if constexpr (type_policy::template is_integral_v<T>)
        cls
            .def("__floordiv__", [](const Interval &a, const T &b) { return a / b; }, py::is_operator(), py::arg("b"),
                 "returns a new multitude with the points divided by a factor of val")
            .def("__ifloordiv__", [](Interval &a, const T &b) { return a /= b; }, py::is_operator(), py::arg("b"),
                 "divides the points of a multitude by a factor of val")
            .def("__mod__", [](const Interval &a, const T &b) { return a % b; }, py::is_operator(), py::arg("b"),
                 "returns a new multitude with points taken as the remainder of the division by val")
            .def("__imod__", [](Interval &a, const T &b) { return a %= b; }, py::is_operator(), py::arg("b"),
    ...
    if constexpr (type_policy::template is_arithmetic_v<T> && !type_policy::template is_integral_v<T>)
        cls
            .def("__truediv__", [](const Interval &a, const T &b) { return a / b; }, py::is_operator(), py::arg("b"),
                 "returns a new multitude with the points divided by a factor of val")
            .def("__itruediv__", [](Interval &a, const T &b) { return a /= b; }, py::is_operator(), py::arg("b"),
                 "divides the points of a multitude by a factor of val");
    if constexpr (std::is_same_v<interval::policy::unknown_type_policy, type_policy>) {
        ...
        cls
            ...
            .def("add_point", [](Interval &self, const V_type &obj) { return self.add_point(cast<T>(obj)); },
                 py::arg("a"),
            ...
            .def("remove_point", [](Interval &self, const V_type &obj) { return self.remove_point(cast<T>(obj)); },
                 py::arg("a"),
            ...
            .def("__contains__", [](Interval &self, const V_type &obj) { return self.in(cast<T>(obj)); }, py::arg("a"),
                 "return true if this point in multitude, else return false")
            .def("contains", [](Interval &self, const V_type &obj) { return self.in(cast<T>(obj)); }, py::arg("a"),
                 "return true if this point in multitude, else return false")
            .def("contains", [](Interval &self, const V_type &obj1, const V_type &obj2) {
            ...
            .def("custom_transfer",
                 [](const Interval &self, const std::function<py::object(const py::object &)> &a, const V_type &b,
                    const V_type &c) {
                     return self.custom_transfer(adapt_fun(a), cast<T>(b), cast<T>(c));
                 }, py::arg("fun"), py::arg("MINUS_INF"), py::arg("PLUS_INF"), transfer2.c_str());
    }
    else
        cls
            .def("add_interval", &Interval::add_interval, py::arg("a"), py::arg("b"),
                 "returns false if all this interval was inside this multitude, else return true")
            ...
            .def("contains",
                 ...
                 py::arg("a"),
                 py::arg("b"), "return true if interval (a, b) in multitude, else return false")
            ...
            .def("any", static_cast<std::optional<T> (Interval::*)(
                     ...
                     const std::function<std::optional<T>(const T &)> &,
                     const std::function<std::optional<T>(const T &, const T &)> &,
                     const std::optional<T> &) const>(&Interval::any), py::arg("MINUS_INF_x"), py::arg("x_PLUS_INF"),
                 py::arg("x_y"), py::arg("MINUS_INF_PLUS_INF"), any2.c_str())
            .def("custom_transfer",
                 static_cast<Interval (Interval::*)(const std::function<T(const T &)> &) const>(&
                     Interval::custom_transfer), py::arg("fun"), transfer1.c_str())
            .def("custom_transfer", static_cast<Interval (Interval::*)
                     (const std::function<T(const T &)> &, const typename Interval::inp_type &,
                      const typename Interval::inp_type &) const>(&Interval::custom_transfer), py::arg("fun"),
                 py::arg("MINUS_INF"), py::arg("PLUS_INF"), transfer2.c_str());
...
All classes and functions are documented with Python-style docstrings.
    ...
    py::class_<interval::policy::int_type_policy> IntTypePolicy(policy_mod, "IntTypePolicy",
                                                                "internal stored type - int. Additional operations are available");
    py::class_<interval::policy::float_type_policy> FloatTypePolicy(policy_mod, "FloatTypePolicy",
    ...
    m.def("Interval", [](const py::object &policy)-> py::object {
        if (policy.is(py::type::of<interval::policy::unknown_type_policy>()) || policy.is_none())
            return py::cast(
                new interval::interval<PyValue, interval::policy::unknown_type_policy>(),
                py::return_value_policy::take_ownership);
        if (policy.is(py::type::of<interval::policy::float_type_policy>()))
            return py::cast(
                new interval::interval<FLOAT_TYPE, interval::policy::float_type_policy>(),
                py::return_value_policy::take_ownership);
        if (policy.is(py::type::of<interval::policy::int_type_policy>()))
            return py::cast(
                new interval::interval<INT_TYPE, interval::policy::int_type_policy>(),
                py::return_value_policy::take_ownership);
